...
Stremio Channels can be used out-of-the-box without configuration.  Select 'Edit Channels' in Projectivy Launcher and choose Stremio Channels.

![myimag](media/screenshots/channels.jpg?raw=true)

There are several built-in channels for the most common channel filters.

![myimag](media/screenshots/defaults.jpg?raw=true)

Launch the Stremio Channels app if you want to add custom channels.

![myimag](media/screenshots/custom.jpg?raw=true)

Choose Section, Media Type, and Genres. Programs generally have to match ALL Genres to show in the channel, so adding too many genres can result in an empty channel.
